...
public class AutoFiveCargoA extends SequentialCommandGroup {
  ...
  public AutoFiveCargoA(Drivetrain sub_drivetrain, Shooter sub_shooter, Turret sub_turret, Hood sub_hood,
    ...
    addCommands(
        parallel(driveForwardsToOne, collectCargo, setShooterRPM1, setTurretPosition1, setHoodPosition1),
        driveBackwardsFromOne,
        shootBall,
        parallel(driveForwardsToTwo, collectCargo, setShooterRPM2, setTurretPosition2, setHoodPosition2),
        shootBall,
        parallel(driveForwardsToTerminal, collectCargo, setShooterRPM3, setTurretPosition3, setHoodPosition3),
